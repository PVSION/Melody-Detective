...
1. Choose the current practice setup from the start menu.
   ...
   - **Beginner** uses white keys only and starts as free practice.
   - **Intermediate** keeps black keys disabled but adds Find One Note streak challenges.
   - **Advanced** unlocks every key and includes Find One Note streak challenges.
2. If you choose **Find One Note** on Intermediate or Advanced, choose a 5-streak, 10-streak, 20-streak, or 30-streak challenge.
...
- **Challenge completion** currently applies to **Intermediate** and **Advanced Find One Note** mode only.
